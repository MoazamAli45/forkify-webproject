...
// Importing icons for parcel as was not working properly
// import icons from '../img/icons.svg';  // parcel 1
// use script type="module "   before import in parcel
import icons from 'url:../../img/icons.svg'; // parcel 2   // 2level up to that file
...
export class RecipeView extends View {
  ...
  addHandlerRender(handler) {
    // controlRecipe argument
    // window.addEventListener('hashchange', controlRecipe);
    // window.addEventListener('load', controlRecipe);
    // by using loop we are doing
